        ...
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <div className="relative max-w-lg">
            <input
              ...
              className="block w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 focus:border-green-500 focus:ring-green-500 dark:border-gray-900 dark:bg-gray-800 dark:text-gray-100"
            />
            <svg
